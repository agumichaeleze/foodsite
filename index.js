...
const tick = () => {
    ...
    const html = `
    <span class=" py-0.5 px-3 text-center inline-block font-bold text-l">${d} <br> Days </span> :
    <span class=" py-0.5 px-3 text-center inline-block">${h} <br> Hrs</span> :
    <span class="py-0.5 px-3 text-center mt-3 inline-block">${m} <br> Min</span> :
    <span class="py-0.5 px-3 text-center mt-3 inline-block"> ${s} <br> Sec</span> 
    `;
